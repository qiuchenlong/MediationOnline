...
//        StringBuilder sb = getFilePath(context, name);
     ...
     * @param name
     */
    public void playRecorder(Context context, String name,Boolean isNetPath) {
        ...
        try {
            ...
            String filePath = "";
//            if (!isNetPath) {
//            	 Log.e("fff", "本地播放路径:" + getFilePath(context, name).toString());
//            	 filePath = getFilePath(context, name).toString();
//			} else {
//				 Log.e("fff", "网络播放路径:" + name);
            	 filePath = name;
//			}
